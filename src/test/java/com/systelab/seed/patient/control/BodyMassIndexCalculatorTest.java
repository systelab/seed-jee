...
class BodyMassIndexCalculatorTest {
    ...
    void checkBMICalculationForCorrectValuesTest(Double weight, Double height, String expectedResultStr) {
    ...
    @TmsLink("TC1234_Formulas")
    @Feature("Goal: This test case is intended to verify the correct calculation of the Body Mass Index")
    static class ComponentSingleTests {
        @Description("Calculate BMI")
        @Test
        void checkSingleCalculation() {
